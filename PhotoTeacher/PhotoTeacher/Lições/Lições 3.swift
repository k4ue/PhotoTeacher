...
let li3 = Lição(titulo: "3. Noções - celular", textoOp: """
    ...
    ngulo normal - a imagem é feita no mesmo nível do observador. Com este ângulo obtemos uma imagem mais natural.
    """, texto3: """
     ngulo Picado ou Plongê - quando fazemos a foto de cima para baixo. Isto aumenta a profundidade da imagem e passa a sensação de inferioridade.

     ngulo contra-picado ou contra-plongê - quando a foto é feita de baixo para cima. Isto aumenta a profundidade da imagem e passa a noção de superioridade.
    ...
    Até mais!
    """, imagemCapa: Images.ImgLicao10!, imagem1: Images.ImgLicao14!, imagem2: Images.ImgLicao13!, imagem3: Images.ImgLicao11!, imagem4: Images.ImgLicao8!, Leon: Images.Leon1!)
